...
sigma = [0.2 0.4 ; 0.3 0.3; 0.6 0.6; 0.3 0.6];
Images1 = zeros(128,128,4);Images2 = zeros(128,128,4);
%for i=1:4
disb1=sigma(2,1)*randn(class_size(1)); 
disb2=sigma(2,2)*randn(class_size(1)); 
