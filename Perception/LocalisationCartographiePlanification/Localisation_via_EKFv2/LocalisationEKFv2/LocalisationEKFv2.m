...
%===============================================================
Indices = ones(1,7);
IndicesActifs = [1 0 0 0 0 1 1]; % On active uniquement les boucles avec le topometre et le GPS
...
%==================================================================
save ResultatFiltres/ResultatGPSINSTopoEKF3 DonneesLocalisationEKF;
